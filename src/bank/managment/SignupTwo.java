...
//        randFormNum = Math.abs(uniFormNum.nextLong() % 9000L) + 1000L;
        JLabel applicationNum = new JLabel("APPLICATION FORM NUMBER. " + 0);
        ...
        try {
            if(name.equals("")){
                ...
                JOptionPane.showMessageDialog(null, "Please Enter Date Of Birth.");
                   ...
                   Conn c = new Conn();
                   String query = "insert into signup Values( '"+name+"' , '"+fatherName+"', '"+motherName+"', '"+email+"', '"+address+"', '"+pin+"', '"+state+"', '"+city+"', '"+dateOfBirth+"', '"+gender+"', '"+maritalStat+"')";
